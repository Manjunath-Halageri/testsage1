...
public class karnat extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new karnap(driver).username,"tomsmith");
        ...
        try
        {
            actions.EnterData(new karnap(driver).password,"SuperSecretPassword!");
        ...
        try
        {
            actions.Click(new karnap(driver).button);
