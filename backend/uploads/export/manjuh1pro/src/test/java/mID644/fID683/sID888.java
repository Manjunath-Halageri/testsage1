...
public class testscript1 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new page1(driver).username,"tomsmith");
        ...
        try
        {
            actions.EnterData(new page1(driver).userpwd,"SuperSecretPassword!");
        ...
        try
        {
            actions.Click(new page1(driver).button);
