...
import reuseablePackage.reuseFunction.demofunClass;
import pom.demo;
import java.io.File;
...
public class manjuts extends  AllActions {
...
int var1=1;
	...
	catch(Exception e)
	{
        ...
        try
        {
            new demofunClass(driver).demofun();
        ...
        try
        {
            actions.EnterData(new demo(driver).uname,"tomsmith");
        ...
        try
        {
            actions.EnterData(new demo(driver).password3,"SuperSecretPassword!");
        ...
        try
        {
            actions.Click(new demo(driver).buttonobj4);
