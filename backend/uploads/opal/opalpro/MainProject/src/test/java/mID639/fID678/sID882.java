...
public class sID882 extends  AllActions {
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.EnterData(new manju(driver).username,"tomsmith");
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.EnterData(new manju(driver).password,"SuperSecretPassword!");
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.Click(new manju(driver).button);
