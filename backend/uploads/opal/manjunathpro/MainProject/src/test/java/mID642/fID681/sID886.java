...
public class sID886 extends  AllActions {
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.EnterData(new opal(driver).input,"tomsmith");
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.EnterData(new opal(driver).input2,"SuperSecretPassword!");
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.Click(new opal(driver).button);
