...
public class sID879 extends  AllActions {
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.EnterData(new ih(driver).input,"tomsmith");
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.EnterData(new ih(driver).input2,"SuperSecretPassword!");
    ...
    Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        try
        {
            actions.Click(new ih(driver).button);
