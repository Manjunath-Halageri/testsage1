module.exports = {
     ...
     */
    jmx1(data, templatePath, scriptPath, callback) {
        const startRecord = `actions.startRecording(scriptName);`;
        const stopRecord = `actions.stopRecording();`;
        ...
        var jmxFileName = data.scriptId + "Jmx";
        ...
        lr.on('line', function (line) {
            if (line.includes(fName)) {
                ...
                var NewLine = oldLine.replace(changeString, jmxFileName)
