...
function handlingUiException(data,callback) 
    {  
        ...
        var findPomClassName = (data) => new Promise ((resolve,reject)=>{
            var navigateToPom = `../../uploads/opal/${data.projectName}/suites/exceptionHandler${data.mainRunNumber}/${data.createdCopySuite}/src/test/java/${data.moduleName}/${data.fetaureName}/${data.scriptName}.java`;
        ...
        // var findPomClassName = (data) => new Promise ((resolve,reject)=>{
        //     var navigateToPom = `../../uploads/opal/${data.projectName}/suites/exceptionHandler/${data.createdCopySuite}/src/test/java/${data.moduleName}/${data.fetaureName}/${data.scriptName}.java`;
        //     var completePathCheck = path.join(__dirname, navigateToPom);
        //     rl = readline(completePathCheck);
        ...
        var findAndChangePom = (pomDoc,pageName009) => new Promise((reslove,reject)=>{
            var domPath = `../../uploads/opal/${data.projectName}/suites/exceptionHandler${data.mainRunNumber}/${data.createdCopySuite}/src/main/java/dom/${data.scriptName}.html`;
        ...
        function callAtOnce(pomDoc,pageName009,objectPageName,runNo)
        {
          //  console.log('Error 2 Error 2 Error 2 Error 2 Error 2 Error 2 Error 2 Error 2 Error 2 Error 2 Error 2 Error 2 ')
           // console.log("mainRunNumber mainRunNumber mainRunNumber mainRunNumber mainRunNumber mainRunNumber "+ runNo)
        ...
        //                 var pomPath = `../../uploads/opal/${data.projectName}/suites/exceptionHandler/${data.createdCopySuite}/src/main/java/pom/${objectPageName}.java`;
                ...
                pomDoc.objectName.forEach(element => {
                    ...
                    if(el.locators === 'id'){
                        ...
                        db.reports.update({"Run":runNo},{$set : {"exceptionObjectData" : ExceptionObjectData}},function(err,doc){
                           ...
                           // console.log(doc);
                            var pomPath = `../../uploads/opal/${data.projectName}/suites/exceptionHandler${data.mainRunNumber}/${data.createdCopySuite}/src/main/java/pom/${objectPageName}.java`;
                            var completePomPath =  path.join(__dirname, pomPath)
                            return updatePom(completePomPath,message[0],el.value)
                        })
                    }
