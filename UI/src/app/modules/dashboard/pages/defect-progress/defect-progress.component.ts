...
@Component({
   selector: 'app-defect-progress',
   templateUrl: './defect-progress.component.html',
   styleUrls: ['./defect-progress.component.css', '../../../../layout/css/parent.css', '../../../../layout/css/table.css']
})
export class DefectProgressComponent implements OnInit {
   pageRoles: Object = {}
   lineGraphForm: any;
   fromDate: any;
   toDate: string;
   ...
   ngOnInit() {
      ...
      this.pageName = "defectProgressPage"
      ...
      data.forEach(e => {
         e.forEach(ele => {
            if (ele.testcaseStatus === "P1") {
               ...
               //   console.log(this.totalPriorityArray1.push(ele.date))
            }
            else if (ele.testcaseStatus === "P2") {
               // alert("p2ssssssssssss")
